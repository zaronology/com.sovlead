      ...
      <div className="relative z-10 mx-auto container px-6 w-full">
        <div className="flex flex-col items-start text-left w-full max-w-4xl">
          <h1 className="hero-headline">
            <span className="text-gold">The Foundry</span>
          </h1>
          ...
          <p className="hero-pg">
            Sovereign Leaders stay oriented under pressure, see clearly in
            chaos, hold direction when urgency pulls them off course, and
